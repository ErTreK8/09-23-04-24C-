...
{
    // while(getchar()!='\n'); //siempre que escannemos algo con el scanf l 'haurem de posar
    do
    {
...
{
    char lletresM[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ¿¡»…ÕœÕ“”⁄‹—«";
	char lletresm[] = "abcdefghijklmnopqrstuvwxyz‡·ËÈÌÔÌÚÛ˙¸ÒÁ";
