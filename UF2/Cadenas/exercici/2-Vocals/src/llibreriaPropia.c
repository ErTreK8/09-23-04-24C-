...
void entrarCadena(char frase[],int longitud)
{
 ...
 void convertirSegonsEnMHS(int acumSegons, int *hores, int *minuts, int *segons)
 {
    
    *hores = acumSegons /3600;
    acumSegons = acumSegons - (*hores)*3600;

    *minuts = acumSegons  /60 ;
    acumSegons = acumSegons - (*minuts)*60;
